...
// 			&& (line[h_vars.i + 1] != '\'' && line[h_vars.i + 1] != '\"'))
// 			h_vars = quotes_double(&h_vars, line);
// 		else if (line[h_vars.i] == '$' && line[h_vars.i + 1] == '?'
// 			&& h_vars.quotes != 1 && line[h_vars.i - 1] != '\\')
// 			h_vars = dollar_question(&h_vars, env_var);
// 		else
// 			h_vars = escaped_dollar(&h_vars, line);
// 	}
// 	h_vars.result[h_vars.j] = '\0';
// 	return (h_vars.result);
// }

// // NOVA WITH PRINTF TO DEBUG
// char	*handle_variables(char *line, t_env *env_var)
// {
// 	t_handle_vars	h_vars;
...
// 	line = change_unquoted_dollar_signs(line);
// printf("line: %s\n", line);
// printf("1result: %s, var_start: %s, var_end: %s, status: %s, 
// i: %d, j: %d, quotes: %d\n", h_vars.result, h_vars.var_start, 
// h_vars.var_end, h_vars.status, h_vars.i, h_vars.j, h_vars.quotes);
// 	if (ft_strchr(line, '$'))
// 	{
// 		h_vars.quotes = is_char_in_quotes(line, ft_strchr(line, '$') - line);
// 		if (h_vars.quotes == 0)
...
// 		// 	ft_strncpy(h_vars.var_name, h_vars.var_start + 1, // <--- AQUI
// 		// 		((h_vars.var_end) - (h_vars.var_start)));
...
// 		// }
// 	}
// printf("2result: %s, var_start: %s, var_end: %s, status: %s, i: %d, 
// j: %d, quotes: %d\n", h_vars.result, h_vars.var_start, 
// h_vars.var_end, h_vars.status, h_vars.i, h_vars.j, h_vars.quotes);
// 	h_vars.i = 0;
// 	h_vars.quotes = ft_strchr(line, '$') - line;
// 	if (h_vars.quotes >= 0)
// 		h_vars.quotes = is_char_in_quotes(line, h_vars.quotes);
// printf("3result: %s, var_start: %s, var_end: %s, status: %s, 
// i: %d, j: %d, quotes: %d\n", h_vars.result, h_vars.var_start, 
// h_vars.var_end, h_vars.status, h_vars.i, h_vars.j, h_vars.quotes);
// 	while (line[h_vars.i] != '\0')
// 	{
...
// 			h_vars = quotes_double(&h_vars, line);
// // 		{
// // printf("4result: %s, var_start: %s, var_end: %s, status: %s, 
// i: %d, j: %d, quotes: %d\n", h_vars.result, h_vars.var_start, 
// h_vars.var_end, h_vars.status, h_vars.i, h_vars.j, h_vars.quotes);
...
// // 			h_vars.var_name = malloc(h_vars.size);
// // 			check_malloc(h_vars.var_name);
// // 			ft_strncpy(h_vars.var_name, h_vars.var_start, // <--- AQUI
// // 				((h_vars.var_end) - (h_vars.var_start)));
// // printf("var_name: %s\n", h_vars.var_name);
// // 			h_vars.var_name[h_vars.var_end - h_vars.var_start] = '\0';
// // printf("5result: %s, var_start: %s, var_end: %s, status: %s, i: 
// %d, j: %d, quotes: %d\n", h_vars.result, h_vars.var_start, 
// h_vars.var_end, h_vars.status, h_vars.i, h_vars.j, h_vars.quotes);
// // printf("var_name: %s\n", h_vars.var_name);
// // 			h_vars.var_value = getenv(h_vars.var_name);
...
// // 			h_vars.size = 0;
// // 			free(h_vars.var_name);
// // printf("6result: %s, var_start: %s, var_end: %s, status: %s, 
// i: %d, j: %d, quotes: %d\n", h_vars.result, h_vars.var_start, 
// h_vars.var_end, h_vars.status, h_vars.i, h_vars.j, h_vars.quotes);
// // 		}
// 		else if (line[h_vars.i] == '$' && line[h_vars.i + 1] == '?'
...
// 			&& (line[h_vars.i + 1] != '\'' && line[h_vars.i + 1] != '\"'))
// 		{
// printf("4result: %s, var_start: %s, var_end: %s, status: %s, i: 
// %d, j: %d, quotes: %d\n", h_vars.result, h_vars.var_start, 
// h_vars.var_end, h_vars.status, h_vars.i, h_vars.j, h_vars.quotes);
// 			h_vars.var_start = &line[h_vars.i + 1];
// 			h_vars.var_end = h_vars.var_start;
...
// printf("var_name: %s\n", h_vars.var_name);
// 			h_vars.var_name[h_vars.var_end - h_vars.var_start] = '\0';
// printf("5result: %s, var_start: %s, var_end: %s, status: %s, 
// i: %d, j: %d, quotes: %d\n", h_vars.result, h_vars.var_start, 
// h_vars.var_end, h_vars.status, h_vars.i, h_vars.j, h_vars.quotes);
// printf("var_name: %s\n", h_vars.var_name);
// 			h_vars.var_value = getenv(h_vars.var_name);
// printf("var_name: %s, var_value: %s\n", h_vars.var_name, h_vars.var_value);
// 			if (h_vars.var_value != NULL)
// 			{
// 				ft_strcpy(&h_vars.result[h_vars.j], h_vars.var_value);
// 				h_vars.j += ft_strlen(h_vars.var_value);
